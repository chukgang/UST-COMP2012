...
int main()
{
	// Create some courses, possibly with pre-requisites
		...
		s1.drop(2021);s1.print_course_plan_tree();
		s1.drop(3021);s1.print_course_plan_tree();
		s1.drop(1001);
		s1.drop(4211);
